...
// Database storage removed. Only using MCP/in-memory modules.
...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.post("/api/mcp/strategies", (req, res) => {
    try {
      // You may want to validate req.body here if needed
      const newStrategy = strategyRepository.createStrategy(req.body);
